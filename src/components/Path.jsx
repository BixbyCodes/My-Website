        ...
        <div className="reveal" style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '24px', padding: '3rem 3rem 2.5rem', overflow: 'hidden' }}>
          ...
          <div style={{ marginBottom: '3.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
              <span style={{ fontFamily: 'JetBrains Mono', fontSize: '0.62rem', letterSpacing: '0.15em', color: 'var(--blue)', border: '1px solid rgba(102,136,204,0.3)', background: 'rgba(102,136,204,0.06)', padding: '0.25rem 0.7rem', borderRadius: '6px' }}>PATH 1</span>
            ...
            <div style={{ position: 'relative', padding: '1rem 0' }}>
              {/* Line */}
              <div style={{ position: 'absolute', top: '50%', left: '0', right: '0', height: '1px', background: 'linear-gradient(90deg, rgba(102,136,204,0.6), rgba(102,136,204,0.15))', transform: 'translateY(-50%)' }} />
                ...
                {[
                  ...
                  <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.6rem', opacity: stop.dim ? 0.3 : 1 }}>
                    <div style={{
                      ...
                      border: `2px solid ${stop.done ? 'var(--blue)' : 'rgba(102,136,204,0.35)'}`,
                      boxShadow: stop.done ? '0 0 12px rgba(102,136,204,0.4)' : 'none',
                      zIndex: 1,
                    }} />
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
              <span style={{ fontFamily: 'JetBrains Mono', fontSize: '0.62rem', letterSpacing: '0.15em', color: 'var(--gold)', border: '1px solid rgba(232,160,32,0.3)', background: 'rgba(232,160,32,0.06)', padding: '0.25rem 0.7rem', borderRadius: '6px' }}>PATH 2</span>
            ...
            <div style={{ position: 'relative', height: '120px' }}>
              <svg viewBox="0 0 900 100" style={{ width: '100%', height: '100%' }} preserveAspectRatio="none">
                <defs>
                  <linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="60%" stopColor="#e8a020" stopOpacity="0.4" />
                    <stop offset="100%" stopColor="#e8a020" stopOpacity="0.15" />
                  </linearGradient>
                </defs>
                {/* Curved dashed path */}
                ...
                {/* Dots */}
                <circle cx="20" cy="50" r="5" fill="#e8a020" filter="url(#glow)" />
                <circle cx="350" cy="30" r="4" fill="none" stroke="#e8a020" strokeWidth="1.5" strokeOpacity="0.6" />
                <circle cx="750" cy="58" r="4" fill="none" stroke="#e8a020" strokeWidth="1" strokeOpacity="0.35" />
                <defs>
              ...
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '100%' }}>
                <div style={{ position: 'absolute', left: '0%', top: '55%', transform: 'translateX(-10px) translateY(8px)', textAlign: 'center' }}>
                  <p style={{ fontFamily: 'JetBrains Mono', fontSize: '0.65rem', color: 'var(--gold)', lineHeight: 1.5 }}>Leave<br />the script</p>
                </div>
                ...
                <div style={{ position: 'absolute', left: '80%', top: '40%', transform: 'translateX(-50%)', textAlign: 'center' }}>
                  <p style={{ fontFamily: 'JetBrains Mono', fontSize: '0.65rem', color: 'var(--gold)', opacity: 0.6, lineHeight: 1.5, fontStyle: 'italic' }}>This path will<br />reveal with time ✦</p>
                </div>
              </div>
            </div>
          </div>
